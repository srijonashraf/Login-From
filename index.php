...
<body>
    ...
    if (isset($_POST['login'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<div class='w-25 bg-success mx-auto mt-3 text-center text-white py-2 rounded'>Login Successful</div>";
        } else {
            // User login failed
            echo "<div class='w-25 bg-danger mx-auto mt-3 text-center text-white py-2 rounded'>Login Failed</div>";
        }
    }
    ?>
